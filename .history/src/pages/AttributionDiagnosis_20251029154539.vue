    ...
    <b-row class="justify-content-center pt-4 mb-4">
      <b-col cols="10" class="text-center">
        ...
        <b-row class="module-container p-3">
          ...
          <!-- 模块 1 - 4 循环展示 -->
          <!-- 关键修正: 使用一个 div.module-wrapper 包裹 col 和 overlay，并在 wrapper 上监听事件 -->
          <div 
            v-for="(module, index) in modules" 
            :key="index" 
            class="module-wrapper col-3 px-3"
...
<style lang="scss" scoped>
  ...
  .module-details-overlay {
    ...
    border-radius: 12px;
    box-shadow: 0 8px 25px rgba(0, 0, 0, 0.5); // 增加阴影，突出浮窗
    z-index: 100;
    text-align: center;
    overflow-y: auto;
